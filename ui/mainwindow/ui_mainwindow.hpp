...
public:
    ...
    QPushButton *testMyPow;
    QPushButton *testMySqrt;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonPow = new QPushButton(verticalLayoutWidget);
        pushButtonPow->setObjectName(QString::fromUtf8("pushButtonPow"));

        verticalLayout->addWidget(pushButtonPow);
        ...
        gridLayout->addWidget(pushButtonLeft, 5, 0, 1, 1);
        ...
        gridLayout->addWidget(pushButtonRight, 5, 1, 1, 1);
        ...
        gridLayout->addWidget(pushButtonPoint, 3, 1, 1, 1);

        pushButtonClear = new QPushButton(gridLayoutWidget);
        pushButtonClear->setObjectName(QString::fromUtf8("pushButtonClear"));

        gridLayout->addWidget(pushButtonClear, 3, 2, 1, 1);
        ...
        verticalLayoutWidget_2->setGeometry(QRect(390, 200, 160, 80));
        verticalLayout_2 = new QVBoxLayout(verticalLayoutWidget_2);
        verticalLayout_2->setObjectName(QString::fromUtf8("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        testMyPow = new QPushButton(verticalLayoutWidget_2);
        testMyPow->setObjectName(QString::fromUtf8("testMyPow"));

        verticalLayout_2->addWidget(testMyPow);

        testMySqrt = new QPushButton(verticalLayoutWidget_2);
        testMySqrt->setObjectName(QString::fromUtf8("testMySqrt"));

        verticalLayout_2->addWidget(testMySqrt);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonPow->setText(QCoreApplication::translate("MainWindow", "^", nullptr));
        ...
        testMyPow->setText(QCoreApplication::translate("MainWindow", "testMyPow", nullptr));
        testMySqrt->setText(QCoreApplication::translate("MainWindow", "testMySqrt", nullptr));
